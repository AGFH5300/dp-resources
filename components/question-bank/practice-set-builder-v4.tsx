  ...
  return (
    <>
      ...
      <div className="mt-6 grid gap-5 xl:grid-cols-[minmax(0,1fr)_380px]">
        <section className={`${styles.selectionPanel} rounded-2xl border p-4 shadow-sm xl:min-h-[calc(100dvh-7.5rem)] xl:overflow-hidden`}>
          <div className={`${styles.selectionViewport} xl:flex xl:min-h-0 xl:flex-col`}>
