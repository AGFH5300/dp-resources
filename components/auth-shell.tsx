        ...
        <aside className="relative hidden overflow-hidden border-r border-[#c3c6ce55] bg-[#ece7db] lg:flex">
          ...
          <div className="relative flex h-full w-full flex-col justify-between p-12 xl:p-16">
            <div>
              ...
              <p className="mt-8 font-label text-xs uppercase tracking-[0.18em] text-[#43474d]">
                {eyebrow}
              </p>
              <h2 className="mt-4 max-w-xl font-headline text-5xl leading-[1.08] text-[#00152a]">
                {title}
              </h2>
              <p className="mt-6 max-w-xl font-body text-lg leading-relaxed text-[#43474d]">
                {description}
              </p>
            </div>
            {quote && attribution ? (
              <div className="rounded-md border border-[#c3c6ce66] bg-white/70 p-7 backdrop-blur-sm">
                <p className="font-headline text-2xl leading-snug text-[#00152a]">
                  “{quote}”
                </p>
                <p className="mt-4 font-body text-sm text-[#43474d]">
                  {attribution}
                </p>
              </div>
            ) : null}
