...
export default async function Admin({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  let memberships:any[]=[]; let logs:any[]=[]; let reports:any[]=[]; let tickets:any[]=[]; let userCount=0; let activityCount=0; let reportCount=0; let ticketCount=0; let indexStatus:any=null;
