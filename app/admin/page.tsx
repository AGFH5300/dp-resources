...
export default async function Admin({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
  ...
  let memberships:any[]=[]; let domainPolicies: Record<string, { allowed: boolean | null; matched_domain: string | null; error?: string | null }> = {}; let logs:any[]=[]; let reports:any[]=[]; let tickets:any[]=[]; let usage:any[]=[]; let usageResource:any=null; let usageUsers:any[]=[]; let usageUserResources:any[]=[]; let diagnostics:any[]=[]; let userCount=0; let activityCount=0; let reportCount=0; let ticketCount=0; let indexStatus:any=null;
