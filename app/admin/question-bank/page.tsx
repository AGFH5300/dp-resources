          ...
          <>
                ...
                <span>
                  <span className="flex items-center gap-1.5">
                    ...
                    <InfoTip label="Blank source items">
                      ...
                      retained in the import history but are not presented as normal
                      answerable questions.
                    </InfoTip>
                  </span>
                  <small>{blankQuestions.toLocaleString()}</small>
                  <small className="mt-1 block text-slate-500">
                    kept for traceability, not counted as usable content
                  </small>
                </span>
              </div>
            ...
            <section className="dp-qb-panel mt-5">
              ...
              <p className="mt-1 max-w-3xl text-sm leading-6 text-slate-600">
                ...
                Resources file. Coverage is not yet complete for every syllabus; the
                exact status is shown below.
              </p>
            ...
            <section className="dp-qb-panel mt-5">
              ...
              <p className="mt-1 text-sm text-slate-600">
                These are notes about the source material, not necessarily live
                website failures.
              </p>
