  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <p className="mt-4 font-body text-[#43474d]">
          Check your inbox for your code and continue verification.
        </p>
        <Link
          href="/auth/login"
          className="mt-8 block w-full bg-[#00152a] py-4 text-white rounded-sm"
        >
          Return to Log In
        </Link>
      </div>
