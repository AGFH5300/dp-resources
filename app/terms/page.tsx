...
export const metadata: Metadata = publicPageMetadata({
  title: 'Terms of Use',
  description:
    'Terms for using DP Resources, including account use, free resource access, reports, support, and platform records.',
  path: '/terms',
});
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <section className="rounded-3xl border border-[#e5dccd] bg-white p-6 shadow-sm sm:p-8">
          ...
          <h1 className="mt-3 text-3xl font-semibold tracking-tight text-[#10243f] sm:text-4xl">
            Use DP Resources responsibly.
          </h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-slate-600">
            DP Resources provides free account-based access to a study resource
            library. By using the platform, you agree to use it fairly, safely,
            and only for appropriate study or school-related purposes.
          </p>
        </section>
