-- Compensating rollback for 20260919190112_fix_resource_usage_visible_time_tracking.sql.
-- Restores the resource-usage heartbeat behavior that was live before that change.
