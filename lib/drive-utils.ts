export const WORKSPACE_EXPORTS: Record<string, { mimeType: string; extension: string }> = {
...
export function workspaceExportFor(mimeType: string) { return WORKSPACE_EXPORTS[mimeType] || null; }
export function normalizeSearch(value = '') { return value.trim().slice(0, 100); }
