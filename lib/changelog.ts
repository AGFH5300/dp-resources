...
const historicalSummaries: Record<string, string[]> = {
  ...
  '2026-07-31': [
    ...
    'Reorganised Mathematics so current AA and AI courses are shown clearly, while older courses are grouped inside one Legacy Mathematics section with current question counts.',
  ...
  '2026-07-24': [
    'Fixed image-based answer choices so diagrams inside Question Bank tables display correctly.',
  ...
  '2026-07-23': [
    ...
    'Improved question details so unavailable marks are shown clearly instead of being estimated.',
