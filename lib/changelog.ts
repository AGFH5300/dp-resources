...
const historicalSummaries: Record<string, string[]> = {
  '2026-07-24': [
    ...
    'Audited every Question Bank variant, corrected malformed marks and source formatting, hid incomplete questions until their missing material is available, and placed notification close buttons neatly inside their toasts.',
  ],
  '2026-07-23': [
