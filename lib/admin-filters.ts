...
export const ACTIONS: ActivityLog['action'][] = [
  'folder_opened',
  'file_opened',
  'download_started',
];
...
export function validAction(value: string | null | undefined) {
  return ACTIONS.includes(value as ActivityLog['action'])
    ? (value as ActivityLog['action'])
    : '';
}
export function dayStart(value: string | null | undefined) {
